...
<section class="max-w-7xl mx-auto px-4 mt-20">
    <h1 class="font-black text-5xl flex items-center gap-2 uppercase">
    ...
    <div class="grid grid-cols-2 gap-4 mt-8 border-y py-4">
        ...
        <a href="">
            ...
            <h2 class="text-2xl font-bold mt-4">{{ $agenda->film->title }}</h2>
            ...
            <div class="flex gap-2 font-light text-sm mt-2">
